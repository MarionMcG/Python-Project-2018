...
f, ax=pl.subplots(1)
ax.scatter(set2,set4, color='r', s =20, label='Iris-Setosa')
ax.scatter(virg2,virg4, color='g', s = 20, label='Iris-Virginica')
ax.scatter(vers2,vers4, color='b', s=20, label='Iris-Versicolor')
ax.set_title('Sepal Width vs. Petal Width')
f.text(0.5, 0.02, 'Sepal Width', ha='center')
f.text(0.03, 0.5, 'Petal Width', va='center', rotation='vertical')
f.legend(loc=1, fontsize='small', shadow=True)
...
f, ax=pl.subplots(1)
ax.scatter(set2,set3, color='r', s =20, label='Iris-Setosa')
ax.scatter(virg2,virg3, color='g', s = 20, label='Iris-Virginica')
ax.scatter(vers2,vers3, color='b', s=20, label='Iris-Versicolor')
